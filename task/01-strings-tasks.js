...
function encodeToRot13(str) {
    ...
    for (var i = 0; i < str.length; i++) {
        if ((str.charCodeAt(i) >= A && str.charCodeAt(i) < N) || 
            (str.charCodeAt(i) >= a && str.charCodeAt(i) < n)) {
            cipherText += String.fromCharCode(str.charCodeAt(i) + 13);
        }
        else if ((str.charCodeAt(i) >= N && str.charCodeAt(i) <= Z) || 
            (str.charCodeAt(i) >= n && str.charCodeAt(i) <= z)) {
            cipherText += String.fromCharCode(str.charCodeAt(i) - 13);
        }
        else
            cipherText += str[i];
